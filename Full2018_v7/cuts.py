...
_tmp = [
    ...
    'mll > 20.',                            # 6. Masa invariante de los dos leptones > 20 GeV 
    'mpmet > 20.',                          # 7. Energía faltante proyectada mínima.
...
z_veto = '((abs(Lepton_pdgId[0]*Lepton_pdgId[1]) != 11*11 && abs(Lepton_pdgId[0]*Lepton_pdgId[1]) != 13*13) || abs(mll - 91.1876) > 15.)'
_tmp.append(z_veto)
...
cuts['ttDM_2018'] = {
    ...
    'categories' : {
        ...
        'emu_ttDM': 'abs(Lepton_pdgId[0]*Lepton_pdgId[1]) == 11*13 && bReq_2bj && Sum((CleanJet_pt > 30) && (abs(CleanJet_eta) < 2.4)) >= 1'

        'emu_tDM': 'abs(Lepton_pdgId[0]*Lepton_pdgId[1]) == 11*13 && bReq_eq1bj && Sum((CleanJet_pt > 30) && (abs(CleanJet_eta) < 2.4)) >= 1'

        'emu_tttDM': 'abs(Lepton_pdgId[0]*Lepton_pdgId[1]) == 11*13 && ((bReq_eq1bj && Sum((CleanJet_pt > 30) && (abs(CleanJet_eta) < 2.4)) >= 1) || (bReq_2bj && Sum((CleanJet_pt > 30) && (abs(CleanJet_eta) < 2.4)) >= 1))'
    }
}
